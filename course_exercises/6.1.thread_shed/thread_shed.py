...
for transaction in daily_transactions_split:
  ...
  for data in transaction:
    clear_transaction.append(data.strip(" ").strip("\n").strip(" ").strip("\n"))
  transactions_clean.append(clear_transaction)
...
def color_count(color): return thread_sold_split.count(color.lower())

colors = ['red', 'yellow', 'green', 'white', 'black', 'blue', 'purple']

for color in colors:
  print("Thread Shed sold {amount} threads of {color} thread today.".format(amount = color_count(color), color = color))